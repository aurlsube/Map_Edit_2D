...
public static class IMG2Sprite
{
    ...
    public static Sprite LoadNewSprite(string FilePath, float PixelsPerUnit = 100f, SpriteMeshType spriteType = SpriteMeshType.Tight)
    {
        ...
        PixelsPerUnit = SpriteTexture.width;
    ...
    public static Sprite ConvertTextureToSprite(Texture2D texture, float PixelsPerUnit, SpriteMeshType spriteType = SpriteMeshType.Tight)
    {
